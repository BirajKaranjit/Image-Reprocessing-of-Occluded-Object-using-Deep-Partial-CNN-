...
from PyQt5.QtWidgets import QDialog,QApplication,QFileDialog,QGraphicsView
...
class MainWindow(QMainWindow):
  ...
  def openImageWindow(self):
    ...
    self.img = cv2.imread(self.imagePath)#loading image
    self.img = cv2.resize(self.img, (512,512), interpolation = cv2.INTER_AREA)#resizng image to 512,512
